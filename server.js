...
console.log('   Source Priority: 1️⃣ System/Platform → 2️⃣ .env file');
console.log(`   AIRTABLE_TOKEN: ${AIRTABLE_TOKEN ? '✅ Set' : '❌ Missing'}`);
console.log(`   CONTACT_BASE_ID: ${CONTACT_BASE_ID ? '✅ Set' : '❌ Missing'}`);
console.log(`   INVOICING_BASE_ID: ${INVOICING_BASE_ID ? '✅ Set' : '❌ Missing'}`);
console.log(`   REPORTS_BASE_ID: ${REPORTS_BASE_ID ? '✅ Set' : '❌ Missing'}`);
